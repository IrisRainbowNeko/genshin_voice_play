...
from dataset.utils import collect_tensor_result, grounding_eval_bbox, genshin_eval_bbox
...
def main(args, config):
    ...
    grd_train_dataset, grd_test_dataset = create_dataset('grounding_genshin', config, args.evaluate)
    ...
    if args.evaluate:
        ...
        if utils.is_main_process():
            # genshin evaluation tools
            refer = pickle.load(open(config['eval_file'],'rb'))
            grounding_acc = genshin_eval_bbox(results, refer)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='configs/Grounding_bbox_genshin.yaml')
