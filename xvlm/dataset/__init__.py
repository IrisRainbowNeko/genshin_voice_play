...
from dataset.grounding_dataset_genshin import grounding_dataset_genshin
...
def create_dataset(dataset, config, evaluate=False):
    ...
    if dataset == 'pretrain':
    ...
    elif dataset == 'grounding_genshin':
        test_dataset = grounding_dataset_genshin(config['test_file'], test_transform, config['image_root'], mode='test', config=config)
        if evaluate:
            return None, test_dataset
        ...
        train_dataset = grounding_dataset_genshin(config['train_file'], train_transform, config['image_root'], mode='train', config=config)
        return train_dataset, test_dataset
